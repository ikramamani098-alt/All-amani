/**
   * Create By 𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍
   * Contact Me on 93748807162
*/
...
const initializeBot = async () => {
    console.clear();
    console.log(chalk.cyan(figlet.textSync('𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍', {
        font: 'Standard',
    ...
    console.log(chalk.green('   𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 𝐩𝐚𝐢𝐫𝐢𝐧𝐠 𝐬𝐲𝐬𝐭𝐞𝐦       '));
    console.log(chalk.yellow('═══════════════════════════════════════════════\n'));
...
function launchBot() {
    console.clear();
    console.log(chalk.green('🚀 Starting 𝗦𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 system...\n'));
    ...
    if (fs.existsSync(botPath)) {
        try {
            ...
            require('./bot');
            telegramLoaded = true;
            console.log(chalk.green('✅𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 bot loaded successfully!'));
        } catch (error) {
    ...
    console.log(chalk.bold.white('𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 BOT INITIALIZATION SUMMARY          '));
    console.log(chalk.cyan('═══════════════════════════════════════════════'));
    console.log(telegramLoaded ? chalk.green('✅𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 тɛℓɛɢяαм вσт: Active') : chalk.red('❌𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 тɛℓɛɢяαм вσт : Inactive'));
    ...
    if (!telegramLoaded && !whatsappLoaded) {
        ...
        console.log(chalk.green('✅ 𖤍 𝐁𝐎𝐒𝐒 𝐁𝐀𝐇𝐑𝐀𝐌 𖤍 system is ready and running!\n'));
    }
